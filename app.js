// --- BASE DE DATOS DE AYUDAS (v3 — URLs directas a convocatoria específica) ---
const ayudasDB = [
    ...
    {
        id: 1,
        nombre: "Kit Digital — Segmento III (Autónomos sin empleados)",
        tipo: "Bono Digital",
        ...
        documentos: [
            "Registro en www.acelerapyme.gob.es + test de diagnóstico digital completado",
            "Certificado de estar al corriente con la AEAT",
            "Certificado de estar al corriente con la Seguridad Social"
        ],
        monto: "Hasta 2.000 €",
        fechaLimite: "Abierta (hasta agotar fondos — BOE Orden TDF/39/2026)",
        dificultad: "Baja",
    ...
    {
        id: 2,
        nombre: "Tarifa Plana RETA — 80 €/mes (12 meses)",
        tipo: "Bonificación de cuota",
        ...
        documentos: [
            "Alta en el RETA (modelo TA.0521 o trámite digital en Import@ss)",
            "No haber cotizado en el RETA en los últimos 2 años (3 si ya la disfrutaste)",
            "Estar al corriente con la AEAT y la Seguridad Social"
        ],
        monto: "Ahorro de ~2.500 € (primer año)",
        fechaLimite: "Permanente (solicitarla en el alta)",
        dificultad: "Baja",
        url: "https://importass.seg-social.es/enportal/publico/landing"
    },
    {
        id: 3,
        nombre: "Plan MOVES III — Vehículos Eléctricos y Recarga",
        tipo: "Subvención directa",
        categoria: "Movilidad Sostenible",
        comunidad: "Nacional",
        requisitos: { sector: "Transporte", antiguedad: "Cualquiera" },
        descripcion: "Subvenciones para adquisición de turismos, furgonetas, motos eléctricas y puntos de recarga. Gestionado por cada CCAA con su propia convocatoria. Importe varía con o sin achatarramiento.",
        documentos: [
            "Factura de compra del vehículo eléctrico nuevo",
            "Ficha técnica ITV homologada del vehículo adquirido",
            "Certificado de baja y achatarramiento del vehículo antiguo (si se pide bonus extra)"
        ],
        monto: "Hasta 9.000 €",
        fechaLimite: "31/12/2026 (por CCAA)",
        dificultad: "Media",
        url: "https://www.idae.es/ayudas-y-financiacion/para-movilidad-y-vehiculos/moves-iii-2025"
    },
    {
        id: 4,
        nombre: "Bono Eficiencia Energética — Hostelería y Turismo",
        tipo: "Subvención directa",
        ...
        documentos: [
            "Auditoría energética previa firmada por técnico competente",
            "Presupuesto de instalación/reforma visado",
            "Licencia de apertura del local en vigor"
        ],
        monto: "Hasta 10.000 €",
        fechaLimite: "31/10/2026",
        dificultad: "Alta",
    ...
    {
        id: 5,
        nombre: "EIC Accelerator — Horizonte Europa (UE)",
        tipo: "Subvención + Inversión",
        categoria: "Innovación / I+D+i",
        comunidad: "Europea",
        requisitos: { sector: "Tecnológico", antiguedad: "12" },
        descripcion: "Financiación directa de la UE para pymes con proyectos de innovación disruptiva a escala global. Combina subvención a fondo perdido (hasta 2,5M€) con equity opcional del EIC Fund (hasta 15M€).",
        documentos: [
            "Short Application: pitch en vídeo (3 min) + deck de 10 diapositivas",
            "Full Application: Business Plan europeo completo (formato EIC)",
            "Presupuesto detallado del proyecto de I+D+i"
        ],
        monto: "Hasta 2.500.000 € + equity opcional",
        fechaLimite: "Abierta — 3 cortes anuales (consulta EIC Work Programme 2026)",
        dificultad: "Muy Alta",
    ...
    {
        id: 6,
        nombre: "Cuota Cero Ampliada — SEF Región de Murcia 2026",
        tipo: "Subvención directa",
        categoria: "Inicio de actividad",
        comunidad: "Murcia",
        requisitos: { sector: "Cualquiera", antiguedad: "0" },
        descripcion: "Reembolso del 100% de las cuotas RETA durante hasta 24 meses para nuevos autónomos murcianos. Convocatoria 2026 activa con ~6 millones de euros presupuestados. Tramitación 100% electrónica.",
        documentos: [
            "Alta IAE y en el RETA (resolución de la SS)",
            "Informe de inscripción como demandante de empleo en el SEF",
            "Certificado de empadronamiento en la Región de Murcia",
            "Declaración responsable de no haber sido autónomo/a en los últimos 2 años"
        ],
        monto: "Hasta 2.920 € (24 meses de cuotas)",
    ...
    {
        id: 7,
        nombre: "Cheque de Innovación — INFO Murcia 2026",
        tipo: "Bono para servicios externos",
        categoria: "Innovación / Competitividad",
        comunidad: "Murcia",
        requisitos: { sector: "Tecnológico", antiguedad: "Cualquiera" },
        descripcion: "Subvención del 70% (hasta 85% en sectores RIS4 Murcia) para contratar servicios externos de innovación y competitividad: consultoría tecnológica, I+D aplicada, propiedad industrial. Dotación: 1M€ en 2026.",
        documentos: [
            "Memoria técnica justificativa del servicio a contratar",
            "Presupuesto proforma del proveedor acreditado por el INFO",
            "Certificados de estar al corriente con AEAT y Seguridad Social"
        ],
        monto: "Hasta 15.000 €",
        fechaLimite: "Hasta agotar fondos (abierta en 2026)",
        dificultad: "Alta",
    ...
    {
        id: 8,
        nombre: "Tarifa Cero — Comunidad de Madrid",
        tipo: "Bonificación de cuota",
        categoria: "Inicio de actividad",
        comunidad: "Madrid",
        requisitos: { sector: "Cualquiera", antiguedad: "0" },
        descripcion: "Reembolso del 100% de la cuota RETA autonómica durante los primeros meses de actividad para nuevos autónomos residentes en la Comunidad de Madrid. Compatible con la Tarifa Plana estatal de 80€.",
        documentos: [
            "Alta en el RETA",
            "Certificado de empadronamiento en la Comunidad de Madrid",
            "Declaración responsable de no haber sido autónomo/a en los 2 últimos años"
        ],
        monto: "Hasta 960 € (reembolso de cuotas)",
        fechaLimite: "Abierta",
        dificultad: "Baja",
    ...
    {
        id: 9,
        nombre: "Ayudas Autónomos y Emprendedores — Ayuntamiento de Madrid 2026",
        tipo: "Subvención directa",
        categoria: "Consolidación / Relevo generacional",
        comunidad: "Madrid",
        requisitos: { sector: "Cualquiera", antiguedad: "12" },
        descripcion: "Nueva convocatoria de 2 millones de euros del Ayuntamiento de Madrid para apoyar la viabilidad de negocios autónomos, traspasos de negocio y creación de empleo. Publicada en junio 2026.",
        documentos: [
            "Plan de viabilidad del negocio (modelo BOCM)",
            "Alta IAE en el municipio de Madrid",
            "Memoria explicativa de la actividad y del empleo generado o a generar"
        ],
        monto: "Hasta 10.000 €",
        fechaLimite: "20 días desde publicación BOCM (junio 2026)",
        dificultad: "Media",
        url: "https://www.comunidad.madrid/empleo/ayudas-personas-trabajadoras-autonomas-emprendedoras-entidades-economia-social"
    },
    {
        id: 10,
        nombre: "Modernización del Comercio — Comunidad de Madrid",
        tipo: "Subvención directa",
        categoria: "Equipamiento / Reforma",
        comunidad: "Madrid",
        requisitos: { sector: "Comercio", antiguedad: "12" },
        descripcion: "Financiación co-financiada con FEDER para obras de mejora, adquisición de mobiliario comercial y equipos en locales comerciales minoristas de la Comunidad de Madrid.",
        documentos: [
            "Proyecto técnico de obra o reforma firmado por técnico competente",
            "Facturas proforma de los proveedores de materiales y equipos",
            "Alta IAE en epígrafe de comercio al por menor",
    ...
    {
        id: 11,
        nombre: "Cuota Cero — Junta de Andalucía (Línea 1)",
        tipo: "Bonificación de cuota",
        categoria: "Inicio de actividad",
        comunidad: "Andalucia",
        requisitos: { sector: "Cualquiera", antiguedad: "0" },
        descripcion: "Subvención del 100% de la cuota RETA durante los primeros meses para mujeres, jóvenes menores de 35 años y colectivos vulnerables que inicien actividad económica en Andalucía.",
        documentos: [
            "Alta en el RETA y en el IAE",
            "Certificado de empadronamiento en Andalucía",
            "Documentación acreditativa del colectivo (DNI con fecha, tarjeta de discapacidad, etc.)"
        ],
        monto: "Hasta 1.440 € (cuotas del periodo subvencionado)",
        fechaLimite: "Abierta",
        dificultad: "Baja",
    ...
    {
        id: 12,
        nombre: "Inicio de Actividad Autónoma — Junta de Andalucía (Línea 2)",
        tipo: "Subvención directa",
        categoria: "Inicio de actividad",
        comunidad: "Andalucia",
        requisitos: { sector: "Cualquiera", antiguedad: "0" },
        descripcion: "Ayuda directa para el inicio de actividad, con cuantías diferenciadas por colectivo: mujeres <35 años (mayor cuantía), hombres <30, mujeres ≥35 y hombres ≥30. Convocatoria conjunta 2025-2026.",
        documentos: [
            "Plan de viabilidad del negocio",
            "Alta en el RETA",
            "Certificado de empadronamiento en Andalucía",
            "Acreditación del colectivo (género/edad con DNI)"
        ],
        monto: "Hasta 5.000 €",
    ...
    {
        id: 13,
        nombre: "Cupones ACCIÓ a la Innovación 2026 — Cataluña",
        tipo: "Bono para servicios externos",
        categoria: "Innovación / Digitalización / IA",
        comunidad: "Cataluña",
        requisitos: { sector: "Tecnológico", antiguedad: "Cualquiera" },
        descripcion: "Cupones directos de la Generalitat de Catalunya para contratar servicios especializados de innovación: inteligencia artificial, sostenibilidad, propiedad industrial y proyectos europeos R+D+I. Cuatro líneas en 2026.",
        documentos: [
            "Registro previo en el portal ACCIÓ (acció.gencat.cat)",
            "Memoria de la necesidad y el servicio a contratar",
            "Presupuesto del proveedor homologado por ACCIÓ"
        ],
        monto: "Hasta 20.000 €",
        fechaLimite: "Hasta agotar fondos (convocatoria abierta mayo 2026)",
        dificultad: "Media",
        url: "https://www.accio.gencat.cat/ca/serveis/innovacio/cupons-a-la-innovacio/"
    },
    {
        id: 14,
        nombre: "Bonificación Alta Autónomo/a — Canal Empresa Catalunya",
        tipo: "Bonificación de cuota",
        categoria: "Inicio de actividad",
        comunidad: "Cataluña",
        requisitos: { sector: "Cualquiera", antiguedad: "0" },
        ...
        documentos: [
            ...
            "No haber estado de alta como autónomo/a en los últimos 2 años"
        ],
        monto: "Hasta 1.200 €",
        fechaLimite: "Permanente",
        dificultad: "Baja",
...
document.addEventListener("DOMContentLoaded", () => {
    const saved = localStorage.getItem("autonometrics_v2");
    if (saved) {
        state = JSON.parse(saved);
    } else {
        const today = new Date().toISOString().split('T')[0];
        state.transacciones = [
            { id: 1, fecha: today, concepto: "Cliente A", tipo: "ingreso", base: 2500, ivaPct: 0.21, estado: "cobrada" },
            { id: 2, fecha: today, concepto: "Cliente B (Impago)", tipo: "ingreso", base: 1200, ivaPct: 0.21, estado: "pendiente" },
            { id: 3, fecha: today, concepto: "Servidores", tipo: "gasto", base: 150, ivaPct: 0.21, estado: "pagado" }
        ];
        guardarDatos();
    }
...
function guardarDatos() { localStorage.setItem("autonometrics_v2", JSON.stringify(state)); }
...
// --- CORE: ACTUALIZAR DASHBOARD Y CÁLCULOS ---
function actualizarUI() {
    const badge = document.getElementById("plan-badge");
    badge.innerText = state.isPremium ? "PRO ACTIVADO" : "GRATIS";
    badge.className = state.isPremium ?
        "text-xs bg-brand-success text-white px-2 py-0.5 rounded-full font-bold mb-3 inline-block" : "text-xs bg-gray-700 text-gray-300 px-2 py-0.5 rounded-full font-bold mb-3 inline-block";
    ...
    [...state.transacciones].reverse().forEach(t => {
...
function addTransaction(e, tipo) {
    e.preventDefault();
    state.transacciones.push({
        ...
        ivaPct: parseFloat(document.getElementById(`${tipo}-iva`).value),
...
// Helper: color del badge de tipo de ayuda
...
function matchAyudas() {
    ...
    const pComunidad = state.perfil.comunidad;
    const pSector = state.perfil.sector;
    const pAntiguedad = state.perfil.antiguedad;

    // Filtrado: Nacional, Europea, o CCAA del perfil
    const ayudasFiltradas = ayudasDB.filter(ayuda => {
        return ayuda.comunidad === "Nacional" || ayuda.comunidad === "Europea" || ayuda.comunidad === pComunidad;
    });

    // Ordenar: mayor match primero
    const ayudasConScore = ayudasFiltradas.map(ayuda => {
        let score = 0;
        ...
        const matchScore = Math.round((score / 2) * 100);
        return { ...ayuda, matchScore };
    }).sort((a, b) => b.matchScore - a.matchScore);

    ayudasConScore.forEach(ayuda => {
        const matchScore = ayuda.matchScore;
        ...
        if (state.isPremium) {
            let docsHTML = ayuda.documentos.map(d => `<li class="flex items-start space-x-1"><span class="text-brand-accent mt-0.5">•</span><span>${d}</span></li>`).join("");
            ...
            card.innerHTML = `
                <div class="space-y-3">
                    ...
                    <h4 class="text-md font-bold text-gray-800 flex items-start space-x-2">
                        <span>✅</span>
                        <a href="${ayuda.url}" target="_blank" rel="noopener noreferrer" class="hover:text-brand-accent transition underline decoration-gray-300 underline-offset-4" title="Ir a la convocatoria oficial">${ayuda.nombre} ↗</a>
                    </h4>
                    ...
                    <div class="flex items-center text-xs font-semibold text-gray-500 space-x-2">
                        <span>⏳ Plazo: <span class="text-brand-danger font-bold">${ayuda.fechaLimite}</span></span>
                    </div>
                    ...
                    <div class="bg-gray-50 p-3 rounded-xl border border-gray-200 mt-2">
                        ...
                        <details class="group cursor-pointer">
                            ...
                            <ul class="text-xs text-gray-600 mt-2 space-y-1.5 pl-1 pb-1">
                                ${docsHTML}
                            </ul>
                        </details>

                        <a href="${ayuda.url}" target="_blank" rel="noopener noreferrer"
                           class="mt-3 flex w-full items-center justify-center space-x-2 text-xs bg-brand-accent hover:bg-blue-600 text-white font-bold py-2 rounded-lg transition">
    ...
    // Contador de ayudas encontradas
    const counter = document.getElementById("ayudas-counter");
    if (counter) {
        counter.innerText = `${ayudasConScore.length} ayuda${ayudasConScore.length !== 1 ? 's' : ''} encontrada${ayudasConScore.length !== 1 ? 's' : ''} para tu perfil`;
    }
}